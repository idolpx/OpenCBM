...
static const unsigned char srq_hs_1571_drive_prog[] = {
#include "srq-hs-1571.inc"
};
...
upload(CBM_FILE fd, unsigned char drive)
{
    ...
    case cbm_dt_cbm1571:
        ...
        srq_drive_prog = srq_hs_1571_drive_prog;
        srq_drive_prog_length = sizeof(srq_hs_1571_drive_prog);
        break;
...
DECLARE_TRANSFER_FUNCS(srq_handshaked);
